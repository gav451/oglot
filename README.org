...
Oglot works with [[https://github.com/non-Jedi/eglot-jl][eglot-jl]] and [[https://github.com/julia-vscode/LanguageServer.jl][LanguageServer.jl]], but the server startup time is
too long for small snippets and the server is too verbose.
...
[[https://github.com/python-lsp/python-lsp-server][python-lsp]] without the [[https://github.com/python-lsp/python-lsp-ruff][python-lsp-ruff]] plugin.  The file [[./examples/julia-mandelbrot.org/][julia-mandelbrot]] is an
[[https://github.com/non-Jedi/eglot-jl][eglot-jl]] example.
